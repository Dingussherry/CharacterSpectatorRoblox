...
searchButton.Position = UDim2.new(0.5, -110, 0, 100)
...
local function updateList()
	...
	if #headsList == 0 then
		infoText.Text = "Головы не найдены. Проверьте Workspace."
	else
		infoText.Text = "Выберите голову из списка"
	end

	print("Character Spectator: Список обновлен, элементов:", #headsList)
end
...
searchButton.MouseButton1Click:Connect(function()
	print("Character Spectator: Кнопка 'Поиск' нажата")
	updateList()
end)

attachCameraButton.MouseButton1Click:Connect(function()
	print("Character Spectator: Кнопка 'Прикрепить камеру' нажата")
	attachCameraToHead()
end)

detachCameraButton.MouseButton1Click:Connect(function()
	print("Character Spectator: Кнопка 'Отсоединить камеру' нажата")
	detachCamera()
end)
...
print("Character Spectator: Автоматический запуск поиска...")
wait(2)
updateList()

print("Character Spectator: Скрипт успешно загружен и готов к работе!")
infoText.Text = "Готов к работе! Выберите голову из списка."
